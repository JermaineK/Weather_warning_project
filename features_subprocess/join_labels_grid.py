...
# -*- coding: utf-8 -*-
"""
join_labels_grid.py  —  schema-pinned label joiner (robust lon-mode & CSV).
...
header so CSV can’t silently drop columns.
...
def main():
    ...
    print(
        ...
        f"(columns preserved: {len(feature_cols)} features + {len(label_cols)} labels)"
    )

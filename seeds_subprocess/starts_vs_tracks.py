...
def main():
    ...
    ap.add_argument("--min-run-hours", type=int, default=18, help="Minimum run length to qualify as a seed start.")
    ap.add_argument("--connectivity", type=int, choices=[4,8], default=4, help="Connectivity for clustering (default 4).")
    ap.add_argument("--radius-deg", type=float, default=4.0, help="Radius for matching to tracks (degrees).")
    ap.add_argument("--time-tol-hours", type=float, default=24.0, help="+/- hours around seed start for matching.")
